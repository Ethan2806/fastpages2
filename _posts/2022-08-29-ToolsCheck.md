 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "Hello everyone, this is my first usage of bash in Jupyter Notebooks! I have a tool checker that displays versions of Python, Anaconda, etc."
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "# packages in environment at /home/jeffrey/anaconda3:\n",
      "#\n",
